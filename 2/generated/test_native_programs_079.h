...
int test_79(fd_executor_test_suite_t *suite) {
 ...
 // {'clock': '', 'epoch_schedule': '', 'epoch_rewards': '', 'fees': '', 'rent': '', 'slot_hashes': '', 'recent_blockhashes': '', 'stake_history': '', 'last_restart_slot': ''}
  ...
  static uchar const fd_flamenco_native_prog_test_79_acc_0_data[] = { 0x00,0x15,0xcd,0x5b,0x07,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_79_acc_0_data;
  test_acc->data_len        = 9UL;
  static uchar const fd_flamenco_native_prog_test_79_acc_0_post_data[] = { 0x00,0x2a,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
...
// https://explorer.solana.com/tx/inspector?message=AQABAkufiIODekYfkR5edUNiYT94SUT5ZX0mviD1V%2B6DGxYrAwZKowAvdNzIbkMxDwwFKvjF2if2EEAZoyPvoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEBAQAJACoAAAAAAAAA
