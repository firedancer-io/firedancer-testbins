#include "../../fd_tests.h"
int test_2389(fd_executor_test_suite_t *suite) {
 ...
 // {'clock': '', 'epoch_schedule': '', 'epoch_rewards': '', 'fees': '', 'rent': '', 'slot_hashes': '', 'recent_blockhashes': '', 'stake_history': '', 'last_restart_slot': ''}
  ...
  test_acc->rent_epoch      = 0;
  test_acc->result_rent_epoch      = 0;
  static uchar const fd_flamenco_native_prog_test_2389_acc_1_post_data[] = { 0x00,0x00 };
  test_acc->result_data     = fd_flamenco_native_prog_test_2389_acc_1_post_data;
